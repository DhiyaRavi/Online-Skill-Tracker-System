    ...
    <Layout style={{ minHeight: "100vh" }}>
      <Sider width={220} theme="dark">
        ...
        <Menu
          theme="dark"
          mode="inline"
          defaultSelectedKeys={["hackerrank"]}
      ...
      <Layout>
        <Header style={{ background: "#fff", padding: "0 24px", display: "flex", justifyContent: "space-between", alignItems: "center", height: 64 }}>
          <Title level={4} style={{ margin: 0 }}>HackerRank Stats & Analysis</Title>
          <Space size={20}>
            <BellOutlined style={{ fontSize: 22 }} />
            <Avatar src={userPic || "https://i.pravatar.cc/150?img=8"} icon={<TrophyOutlined />} />
        ...
        <Content style={{ margin: "24px" }}>
            <div style={{ background: '#fff', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                <Title level={4}>HackerRank Tracker</Title>
